 ...
 */
gboolean property_preflight_string_enum (const gchar         *property_name,
                                          GVariant            *value,
 ...
 */
gboolean property_preflight_normalize_string_enum (const gchar         *property_name,
                                                    GVariant           **value,
                                                    const gchar *const  *valid_values,
                                                    const gchar         *interface,
                                                    GError             **error);
 ...
 */
gboolean property_preflight_double_range (const gchar *property_name,
                                           GVariant    *value,
                                           gdouble      min_value,
                                           gdouble      max_value,
                                           const gchar *interface,
 ...
 * Returns: always %TRUE.
 */
gboolean property_preflight_clamp_double_range (const gchar  *property_name,
                                                 GVariant    **value,
                                                 gdouble       min_value,
                                                 gdouble       max_value,
                                                 GError      **error);
 ...
 * type "i" (gint32).
 */
gboolean property_preflight_int_range (const gchar *property_name,
                                        GVariant    *value,
                                        gint         min_value,
                                        gint         max_value,
                                        const gchar *interface,
 ...
 * type "i" (gint32).
 */
gboolean property_preflight_clamp_int_range (const gchar  *property_name,
                                              GVariant    **value,
                                              gint          min_value,
                                              gint          max_value,
                                              GError      **error);
 ...
 */
#define PROPERTY_PREFLIGHT_DEFINE_SKELETON(TypeName, type_name, \
                                            ParentType, ParentTypeMacro, \
                                            PublicType, PublicCastMacro, \
                                            ValidateFunc) \
\
struct _##TypeName \
{ \
...
\
static gboolean \
type_name##_set_property (GDBusConnection  *connection, \
                           const gchar      *sender, \
...
\
  ...
  if (effective_value == NULL) \
    return TRUE; \
\
  result = type_name##_original_set_property (connection, sender, object_path, \
                                               interface_name, property_name, \
                                               effective_value, error, user_data); \
\
...
type_name##_get_vtable (GDBusInterfaceSkeleton *skeleton) \
{ \
