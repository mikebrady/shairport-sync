...
* Remote Control – Remote control commands -- such as `play`, `pause`, and volume-setting commands -- can be sent to players via the D-Bus, MPRIS and MQTT interfaces.
